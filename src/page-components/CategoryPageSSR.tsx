      ...
      <div className="flex-grow">
        <div className="max-w-7xl mx-auto py-6 px-2 md:px-0">
          ...
          <div className="my-12 w-full">
            <div
              className="w-full max-w-7xl mx-auto bg-zinc-100 dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-700 rounded-lg flex flex-col items-center py-8"
              style={{ minHeight: '120px', height: '120px', maxWidth: '1200px', width: '100%' }}
            >
              <span className="text-xs uppercase tracking-widest text-zinc-500 mb-2">Publicité</span>
